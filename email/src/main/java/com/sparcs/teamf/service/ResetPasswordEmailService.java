...
@Slf4j
public class ResetPasswordEmailService implements AuthEmailSender {
    ...
    @Override
    @Async
    public void sendSignupEmail(String email, int verificationCode) {
        send(email, verificationCode);
    }

    @Override
    @Async
    public void sendRegisterEmail(String email, int verificationCode) {
        send(email, verificationCode);
    }
